...
<html lang="es">
    <head>
        <title>Mantenimiento Concepto de Gastos</title>
...
<!--        <section class="content">-->
            ...
            <div class="col-md-12 ">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-12 ">
                            <div class="panel-body">
                                <form  id="frm_concepto_gasto"  method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <button type="button" onclick="guardarConceptoGasto()" value="enviar" name="env" id="env" class="btn btn-info w-sm m-b-5" style="border-radius: 0px;"><i class="fa fa-send-o"></i>&ensp;Enviar</button>&nbsp;&nbsp;
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <script src="vistas/com/contabilidadConceptoGasto/concepto_gasto.js"></script>
        <script>
