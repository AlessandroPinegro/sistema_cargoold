        ...
        <script src="<?php echo $url_libs_imagina;?>assets/easypie-chart/easypiechart.min.js"></script>
         
        <script src="<?php echo $url_libs_imagina;?>assets/easypie-chart/jquery.easypiechart.min.js"></script>
       <script src="<?php echo $url_libs_imagina;?>assets/easypie-chart/example.js"></script>
       
       
       <script src="<?php echo $url_libs_imagina;?>assets/sparkline-chart/jquery.sparkline.min.js"></script>
       <script src="<?php echo $url_libs_imagina;?>assets/sparkline-chart/chart-sparkline.js"></script>
 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
        ...
        <script src="<?php echo $url_libs_imagina; ?>assets/bootstrap-inputmask/bootstrap-inputmask.min.js"></script> 
         <!--Agregado para manejo de los TABS, JqueryUI MANTENEDOR TIPO DE VENTA-->
        <!--<script src="/sgi/vistas/libs/imagina/js/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>-->