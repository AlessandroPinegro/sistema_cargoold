...
//                loaderClose();
            ...
            case 'validarMovimientoBienEdicionEliminar':
                onResponseValidarMovimientoBienEdicionEliminar(response.data, response[PARAM_TAG]);
                loaderClose();
                break;
...
//        }
        ...
        if (!isEmpty(dataCofiguracionInicial.contOperacionTipo)) {
            ...
            var dataContOperacionTipoFiltrado = dataContOperacionTipo.filter(item => item.documento_tipo_id == cbo_documento_tipo_id);
...
//                        case 17:
            ...
            var readonly = (parseInt(item.edicion_habilitar) === 0) ? 'readonly="true"' : '';
            switch (parseInt(item.tipo)) {
                //combos
                case 4:
                case 5:
            ...
            switch (parseInt(item.tipo)) {
                ...
                case 7:
                    ...
                    $("#contenedorSerie").html('<input type="text" id="txt_' + item.id + '" name="txt_' + item.id + '" ' + readonly + ' class="form-control" value="' + value + '" maxlength="' + longitudMaxima + '" placeholder="Serie"  style="text-align: right;"/>');
                    break;
                ...
                case 8:
                    ...
                    $("#contenedorNumero").html('<input type="text" id="txt_' + item.id + '" name="txt_' + item.id + '" ' + readonly + ' class="form-control" value="' + value + '" maxlength="' + longitudMaxima + '" placeholder="Número"  style="text-align: right;"/>');
                    break;
                case 33:
                ...
                case 15:
                    ...
                    $("#txtDescripcionIGV").css("font-weight", "");
                    break;
                case 16:
...
//                    $("#chkIncluyeIGV").prop("checked", "checked");
                ...
                case 13:
                    ...
                    html += '<input type="text" id="txt_' + item.id + '" name="txt_' + item.id + '" ' + readonly + ' class="form-control" value="' + value + '" maxlength="' + longitudMaxima + '"/>';
                    break;
                case 9:
                    fechaEmisionId = item.id;
                    html += '<input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="datepicker_' + item.id + '"  ' + readonly + ' onchange="obtenerTipoCambioDatepicker();">' +
                            '<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>';
                    break;
                case 3:
                case 10:
                case 11:
                    html += '<input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="datepicker_' + item.id + '"' + readonly + ' >' +
                            '<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>';
                    break;
                case 4:
                    html += '<select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2"></select>';
                    id_cboMotivoMov = (dataCofiguracionInicial.movimientoTipo[0]["codigo"] == 20) ? item.id : null;
                    break;
                case 5:
                    html += '<div id ="div_persona" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
                    html += '<option value="' + 0 + '">Seleccione ' + item.descripcion.toLowerCase() + '</option>';
...
//                    html += '<div class="form-group col-lg-4"><a href="#" class="btn btn-info w-sm m-b-5" id="id" style="border-radius: 0px;" onclick="cargarPersona();" ><i class="ion-plus"></i></div></div>';
                ...
                case 17:
                    var htmlOrg = '';
                    htmlOrg += '<div id ="div_organizador_destino" ><select name="cbo_' + item.id + '" ' + readonly + ' id="cbo_' + item.id + '" class="select2" placeholder="Seleccione almacén de llegada">';
                ...
                case 18:
                    ...
                    html += '<div id ="div_direccion" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
                    //html += '<option value="' + 0 + '">Seleccione la dirección</option>';
                    html += '</select>';
//                    html += '<div class="form-group col-lg-4"><a href="#" class="btn btn-info w-sm m-b-5" id="id" style="border-radius: 0px;" onclick="cargarPersona();" ><i class="ion-plus"></i></div></div>';
                    break;
                case 20:
                    html += '<div id ="div_cuenta" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
                    ...
                    break;
                case 21:
                    html += '<div id ="div_actividad" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
                    ...
                    break;
                case 22:
                    html += '<div id ="div_retencion_detraccion" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
                    ...
                    break;
                case 23:
                    html += '<div id ="div_persona_' + item.id + '" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
...
//                    $("#contenedorCambioPersonalizado").show();
                ...
                case 25:
                    ...
                    break;
                case 26:
                    html += '<div id ="div_vendedor" ><select name="cbo_' + item.id + '" id="cbo_' + item.id + '" ' + readonly + ' class="select2">';
                    html += '<option value="' + 0 + '">Seleccione ' + item.descripcion.toLowerCase() + '</option>';
                    if (!isEmpty(item.data)) {
                        $.each(item.data, function (indexPersona, itemPersona) {
...
//                    break;
    ...
    if (!isEmpty(valoresFormularioDetalle.organizadorId)) {
        select2.asignarValor("cboOrganizador", valoresFormularioDetalle.organizadorId);
    }
}
...
//    }
    obtenerDistribucion();
    if (!validarDistribucion() && distribucionObligatoria == 1) {
        return;
    }
...
function asignarImporteDocumento() {
    ...
    if (!isEmpty(importes.calculoId)) {
        ...
        if (!isEmpty(importes.fleteId) && !isEmpty(importes.seguroId)) {
            ...
            importe_seguro = (!isEmpty(importe_seguro) ? importe_seguro : 0);
            var importe_flete = parseFloat($('#' + importes.fleteId).val());
            importe_flete = (!isEmpty(importe_flete) ? importe_flete : 0);
...
//    $('#modalDocumentoRelacion').modal('hide');   
    if (data.documentoACopiar[0].incluye_igv == 1) {
        $("#chkIncluyeIGV").prop("checked", true);
    } else {
        $("#chkIncluyeIGV").prop("checked", false);
    }
...
//                        }
                        $('#txt_' + item.otro_documento_id).val(devolverDosDecimales(item.valor));
                        break;
                        //CADENA
                    case 2:
                    case 6:
                    ...
                    case 25:
                        ...
                        break;
                    case 36:
                        select2.asignarValor('cbo_' + item.otro_documento_id, (isEmpty(item.valor) ? '0' : item.valor));
        ...
        $.each(data, function (index, item) {
            cargarDataTableDocumentoACopiar(
                    cargarFormularioDetalleACopiar(item.organizador_id, item.bien_id, item.cantidad,
                            ...
                            item.movimiento_bien_detalle, item.dataUnidadMedida, item.movimiento_bien_id, item.bien_activo_fijo_id
                            )
                    );
...
function cargarFormularioDetalleACopiar(organizadorId, bienId, cantidad, unidadMedidaId, precio,
        organizadorDesc, bienDesc, unidadMedidaDesc, precioTipoId, movimientoBienDetalle, dataUnidadMedida, movimientoBienId, bienActivoFijoId) {
    ...
    if (!existeColumnaCodigo(15)) {
        if (muestraOrganizador && isEmpty(organizadorId)) {
            objDetalle.organizadorId = select2.obtenerValor('cboOrganizador');
        } else {
            objDetalle.organizadorId = organizadorId;
        }
    }
    objDetalle.bienActivoFijoId = bienActivoFijoId;
    objDetalle.detalle = detDetalle;
    return objDetalle;
}
...
function cargarDistribucionContable(data) {
    if (!isEmpty(data)) {
        ...
        $.each(data, function (index, item) {
            agregarFilaDistribucion(1);
            select2.asignarValor("cboCuentaContable_" + indice, item.plan_contable_id);
            ...
            document.getElementById('txtPorcentajeDistribucion_' + indice).value = item.porcentaje * 1;
            document.getElementById('txtMontoDistribucion_' + indice).value = item.monto * 1;
...
function actualizarMontoDistribucion(indice) {
    ...
    if (porcentajeAcumulado > 100) {
        var nuevo_porcentaje = devolverDosDecimales(100 - porcentajeAcumulado + porcentaje);
...
function obtenerSubTotal_Total_Distribucion() {
    ...
    if (importes.subTotalId == importes.calculoId || (checkIGV && !isEmpty(importes.subTotalId))) {
        ...
        if ($('#' + importes.icbpId).length != 0 && !isEmpty($('#' + importes.icbpId).val())) {
...
function obtenerDistribucion() {
    ...
    for (var i = 0; i < nroFilasDistribucion; i++) {
        if ($('#txtNumItemDistribucion_' + i).length > 0) {
            ...
            if ($("#cboCentroCosto_" + i).length > 0 && !isEmpty(select2.obtenerValor("cboCentroCosto_" + i))) {
...
function validarDistribucion() {
    ...
    for (var i = 0; i < dataDistribucion.length; i++) {
        var monto = !isEmpty(dataDistribucion[i].monto) ? dataDistribucion[i].monto * 1 : 0;
        if (isEmpty(dataDistribucion[i].plan_contable_id)) {
            mostrarValidacionLoaderClose('Distribución contable: debe seleccionar la cuenta contable en la fila ' + dataDistribucion[i].linea + '.');
            return false;
        }

        let codigoCuentaContable = dataCofiguracionInicial.cuentaContable.filter(item => item.id == dataDistribucion[i].plan_contable_id)[0]['codigo'];

        if ((operacionTipo.requiere_centro_costo === '1' && isEmpty(dataDistribucion[i].centro_costo_id)) || (operacionTipo.requiere_centro_costo === '2' && codigoCuentaContable.substr(0, 1) == '6' && codigoCuentaContable.substr(0, 2) != '60' && codigoCuentaContable.substr(0, 2) != '61' && codigoCuentaContable.substr(0, 2) != '69' && isEmpty(dataDistribucion[i].centro_costo_id))) {
            mostrarValidacionLoaderClose('Distribución contable: debe seleccionar el centro de costo en la fila ' + dataDistribucion[i].linea + '.');
            return false;
        }

        if (monto < 0) {
            mostrarValidacionLoaderClose('Distribución contable: el monto en la fila ' + dataDistribucion[i].linea + ' debe ser mayor que cero.');
            return false;
        } else if (monto > obtenerSubTotal_Total_Distribucion()) {
            mostrarValidacionLoaderClose('Distribución contable: el monto en la fila ' + dataDistribucion[i].linea + ' sobre pasa el monto máximo ' + obtenerSubTotal_Total_Distribucion() + '.');
            return false;
        } else {
            monto_total += monto;
        }
        ...
        if (dataDistribucion[i].porcentaje * 1 < 0) {
            mostrarValidacionLoaderClose('Distribución contable: el porcentaje en la fila ' + dataDistribucion[i].linea + ' debe ser mayor que cero.');
            return false;
        } else if (dataDistribucion[i].porcentaje * 1 > 100) {
            mostrarValidacionLoaderClose('Distribución contable: el porcentaje en la fila ' + dataDistribucion[i].linea + ' no debe ser mayor de lo permitido 100%.');
            return false;
        } else {
    ...
    if (devolverDosDecimales(monto_total) != devolverDosDecimales(obtenerSubTotal_Total_Distribucion())) {
        mostrarValidacionLoaderClose('Distribución contable: la suma de los montos debe ser ' + obtenerSubTotal_Total_Distribucion() + '.');
        return false;
    }

    if (devolverDosDecimales(porcentaje) != 100) {
        mostrarValidacionLoaderClose('Distribución contable: la suma de porcentajes debe ser  100.00%.');
        return false;
    }
...
function obtenerMontoDetraccion() {
    if ($('#cbo_' + cboDetraccionId).length != 0) {
