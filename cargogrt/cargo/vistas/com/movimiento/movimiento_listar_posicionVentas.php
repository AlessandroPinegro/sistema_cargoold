            ...
            <div class="portlet">
                <div class="row">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="portlet-heading bg-info m-b-0" onclick="colapsarBuscador()" style="padding-top: 13px;padding-bottom: 13px;cursor: pointer; cursor: hand;">
                ...
                <div id="bg-info" class="panel-collapse collapse in">
                    <div class="portlet-body">
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboAgenciaOrigen" id="cboAgenciaOrigen" class="select2" onchange="onChangeCboAgencia(this.value)" placeholder="Seleccione origen" multiple=""></select>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label>Agencia Destino</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboAgenciaDestino" id="cboAgenciaDestino" class="select2" placeholder="Seleccione destino" multiple=""></select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboUbigeoOrigen" id="cboUbigeoOrigen" class="select2" placeholder="Seleccione origen" multiple=""></select>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label>Ciudad Destino</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboUbigeoDestino" id="cboUbigeoDestino" class="select2" placeholder="Seleccione destino" multiple=""></select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div id="divBusquedaCboRemitente" class="form-group col-md-4">
                                <label>Remitente</label>
                                <select name="cboRemitenteListado" id="cboRemitenteListado" class="select2" placeholder="Ingrese su documento o su nombre"></select>
                            </div>
                            <div id="divBusquedaCboDestinatario" class="form-group col-md-4">
                                <label>Destinatario</label>
                                <select name="cboDestinatarioListado" id="cboDestinatarioListado" class="select2" placeholder="Ingrese su documento o su nombre"></select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <label>Serie de pedido</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Ingrese pedido" id="txtSeriePedido" name="txtSeriePedido">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                <label>Número de pedido</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Ingrese pedido" id="txtNumeroPedido" name="txtNumeroPedido">
                                </div>
                            </div>


                            <div class="form-group col-md-2">
                                <label>Por Fecha de pedido</label>
                                <div class="input-group col-lg-12 col-md-16 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="fechaPedido">
                            ...
                            <div class="form-group col-md-2">
                                <br>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control fecha" placeholder="dd/mm/yyyy" id="fechaFinP">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div> 
                            <div class="form-group col-md-2">
                                <label>Por Fecha de comprobante</label>
                                <div class="input-group col-lg-12 col-md-16 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="form-group col-md-2">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Ingrese comprobante" id="txtSerieComprobante" name="txtNumeroComprobante">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                            ...
                            <div id="divBusquedaCboTipoDocumento" class="form-group col-md-2">
                                <label>Tipo de documento</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboTipoDocumentoComprobante" id="cboTipoDocumentoComprobante" class="select2" placeholder="Seleccione documento" multiple=""></select>
                                </div>
                            </div>
                            <div id="divCboCaja" class="form-group col-md-3">
                                <label>Caja</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboCaja" id="cboCaja" class="select2" placeholder="Seleccione caja" multiple=""></select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboModalidad" id="cboModalidad" class="select2" placeholder="Seleccione modalida"></select>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label>Estado</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label class="cr-styled" style="text-align: left;">
                                        ...
                                        <i class="fa"></i>
                                        <median>Ver Detalle</median>
                                    </label>
                                </div>
                                <div class="col-md-8">
                                    <label>Artículo</label>
                                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <select name="cboArticulo" id="cboArticulo" class="select2" placeholder="Seleccione artículo" multiple=""></select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="modal-footer">
                                ...
                                <button type="button" onclick="exportarPosicionVentas()" class="btn btn-success"><i class="fa fa-download"></i>&nbsp; Exportar</button>&nbsp;
    ...
    <div class="col-md-12">
        <div class="col-lg-4 col-sm-8">
            <div class="widget-panel widget-style-2 bg-info">
                <i class="ion-cash"></i>
                <h2 id="totalS" class="m-0 counter"></h2>
        ...
        <div class="col-lg-4 col-sm-8">
            <div class="widget-panel widget-style-2 bg-pink">
                ...
                <h2 id="totalK" class="m-0 counter"></h2>
                <div>Total Kilos</div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-4">
            <div class="widget-panel widget-style-2 bg-purple">
                ...
                <h2 id="totalV" class="m-0 counter"></h2>
                <div>Total de paquetes</div>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="col-lg-4 col-sm-4">
            <div class="widget-panel widget-style-2 bg-warning">
                ...
                <h2 id="totalCR" class="m-0 counter"></h2>
                <div>Total de costo reparto</div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-4">
            <div class="widget-panel widget-style-2 bg-primary">
                ...
                <h2 id="totalDC" class="m-0 counter"></h2>
                <div>Total de Devolucion Cargo</div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-4">
            <div class="widget-panel widget-style-2 bg-success">
                <i class="ion-bag"></i>
                <h2 id="totalOC" class="m-0 counter"></h2>
                <div>Total de Otros Cargos</div>
            </div>
        </div>
    </div>
    <div class="col-md-12">
            ...
            <div class="panel panel-default m-t-20 p-t-0">
                ...
                <table id="datatable" class="table table-small-font table-striped table-hover" width="100%">
                    <thead id="theadListado">
                        <tr>
                            <th style='text-align:center;' width="5%">Agencia</th>

                            <th style='text-align:center;' width="5%">F.Pedido</th>
                            <th style='text-align:center;' width="10%">Pedido</th>
                            <th style='text-align:center;' width="10%">Cliente</th>
                            <th style='text-align:center;' width="10%">Destinatario</th>
                            <th style='text-align:center;' width="5%">Destino</th>
                            ...
                            <th style='text-align:center;' width="10%">Caja</th>
                            <th style='text-align:center;' width="5%">Tipo de Venta</th>
                            ...
                            <th style='text-align:center;' width="5%">Cantidad Kilos</th>
            ...
            <div class="modal-body">
                <div class="row">
                    <div id="divContenedorAdjunto" class="form-group col-md-4">
                        <!--<h4>-->
                        <div class="fileUpload btn btn-purple" style="border-radius: 0px;" id="idPopover" title="" data-toggle="popover" data-placement="top" data-content="">
...
<script src="vistas/com/movimiento/movimiento_listar_posicionVentas.js?<?php echo date('Y.m.d.H.i.s') ?>"></script>