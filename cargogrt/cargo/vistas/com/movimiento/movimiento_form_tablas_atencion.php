    ...
    <body> 
                    ...
                    <div class="portlet-heading">               
                        <div class="row">                    
                            <div class="col-md-10" style="margin-top: -12px; margin-left: -32px;">  
                                <div class="col-md-7">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-top: -12px;">
        ...
        <div id="modalDocumentoRelacion"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">  
            <div class="modal-dialog modal-full">      
                <div class="modal-content">          
                    <div class="modal-header">
                        <h4 class="modal-title"><strong> ORDEN DE VENTA</strong></h4>
                    </div>
                    <div class="modal-body">          
                        <div class="row">                       
                            <div class="col-lg-12">                   
        ...
        <!-- /.modal -->
        <!--Modal para seleccionar los correos.-->    
        <div id="modalAtenciones" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">  
            <div class="modal-dialog modal-lg">    
                <div class="modal-content">         
                    <div class="modal-header">            
                        <button type="button"  class="close" data-dismiss="modal" aria-hidden="true">×</button> 
                        <h4>Programación de atenciones</h4>        
                    </div>          
                    <div class="modal-body">   
                        <div class="row">
                    ...
                    <div class="modal-footer">  
                        <a class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"></i>&ensp;Cerrar</a>     
                    </div>     
                </div>        
            </div>       
        </div>     
        ...
        <script src="vistas/com/movimiento/movimiento_form_tablas_atencion.js">
        </script>    
    </body>
</html>