                        ...
                        <div class="btn-toolbar" role="toolbar"  style="float: right" >
                            ...
                            <!-- <div class="input-group-btn" style="padding-left: 10px;">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li id="GenerarNC" hidden>
                                        <a  onclick="generarNotaDeCredito()">
                                            <i class="fa ion-android-add"></i>&nbsp;&nbsp; Generar para Ingresos M.
                                        </a>
                                    </li>
                                </ul>
                            </div> -->
...
<script src="vistas/com/movimiento/movimiento_listar.js"></script>