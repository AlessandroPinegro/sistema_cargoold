<div class="wraper container-fluid">
    ...
    <div class="row">
        ...
        <input type="hidden" id="documentoGenerarGuiaId" value="<?php echo $_GET['documentoGenerarGuiaId']; ?>" />
                ...
                <div id="bg-info" class="panel-collapse collapse in">
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div id="divBusquedaCboRemitente" class="form-group col-md-4" hidden="">
                            ...
                            <div id="divBusquedaCboDestinatario" class="form-group col-md-4">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12" hidden="">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>Origen</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboAgenciaOrigen" id="cboAgenciaOrigen" class="select2" placeholder="Seleccione origen" multiple=""></select>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label>Destino</label>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboUsuarioBuscar" id="cboUsuarioBuscar" class="select2" placeholder="Seleccione usuario">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="modal-footer" style="text-align: right;">                                     
                                ...
                                <label style="text-align: left;  width: 30%" class="cr-styled">
                                    <select name="obervacionpedido" id="obervacionpedido" style=" width: 80%;" class="select2"  aria-label=".form-select-lg example">
                                    <option selected></option>
                                    <option style=" width: 150%" value="1">01 | P. POR ENTREGAR MAYORES A UN MES</option>
                                    <option style=" width: 150%" value="2"> 02 | P. POR ENTREGAR MAYORES A DOS MESES</option>
                                    <option  style=" width: 150%" value="3"> 03 | P. POR ENTREGAR MAYORES A TRES MESES</option>
                                </select>
                                </label>
...
<!--:::::::::: DESARROLLO JESUS  modal estadosobservacion-->
<div id="modalObnservacionEstado" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Agregar Observacion del Pedido</h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        <b for="inputEmail4" class="text-dark">Estado</b>
                        <br>
                        <select id="tipoEstado" class="select2 " aria-label=".form-select-lg example">
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        <b for="inputEmail4" class="text-dark">Descripcion</b>
                        <textarea id="descripcion" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button onclick="guardarEstadoObservacion()" id="modalguardar" type="button" class="btn btn-primary" data-bs-dismiss="modal">Guardar</button>
            </div>
        </div>
    </div>
</div>
...
<div id="modalAnulacion" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="form-group col-md-12">
                    <a class="btn btn-danger w-sm m-b-5" id="id" style="border-radius: 0px;margin-bottom: 0px;" data-dismiss="modal"><i class="fa fa-close"></i>&ensp;Cancelar</a>&nbsp;&nbsp;&nbsp;
...
<script src="vistas/com/movimiento/movimiento_listar_static.js?<?php echo date('Y.m.d.H.i.s') ?>"></script>