                ...
                <table id="datatable" class="table table-small-font table-striped table-hover"   width="100%">
                    <thead id="theadListado">
                        <tr>
                            ...
                            <th style='text-align:center;' width="10%">Bus</th>
                            <th style='text-align:center;' width="20%">Conductor</th>
                            <th style='text-align:center;' width="10%">Origen</th>
                            <th style='text-align:center;' width="10%">Bultos</th>
...
<script src="vistas/com/movimiento/movimiento_listar_manifiesto_reparto.js"></script>
