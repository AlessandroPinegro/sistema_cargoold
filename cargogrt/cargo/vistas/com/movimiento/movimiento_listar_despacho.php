                    ...
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboCopiloto" id="cboCopiloto" class="select2" placeholder="Seleccione copiloto"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-2">
                                <label>Nro de Despacho</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Nro de Despacho" id="despacho">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                <label>Nro de Manifiesto</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" class="form-control" placeholder="Nro de Manifiesto" id="manifiesto">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                <label>Origen</label>
                            ...
                            <div class="form-group col-md-2">
                                <label>Estado</label>
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboEstadoDespacho" id="cboEstadoDespacho" class="select2" placeholder="Seleccione Estado" multiple="">
                                        <option value="14">Generado</option>
                                        <option value="8">Pendiente de Confirmacion</option>
                                   ...
                                   <div class="col-md-2">
                                    ...
                                    <label class="cr-styled" style="text-align: left;">
                                        ...
                                        <i class="fa"></i>
                                        <median>Ver Despachos por recibir</median>
                                    </label>
                                </div>
                        </div>
                ...
                <table id="datatable" class="table table-small-font table-striped table-hover"   width="100%">
                    <thead id="theadListado">
                        <tr>
                            ...
                            <th style='text-align:center;' width="10%">Fecha de salida</th>
                            <th style='text-align:center;' width="8%">Bus</th>
                            <th style='text-align:center;' width="19%">Conductor</th>
                            <th style='text-align:center;' width="19%">Copiloto</th>
                            ...
                            <th style='text-align:center;' width="8%">Nro Manifiesto(s)</th>
...
<script src="vistas/com/movimiento/movimiento_listar_despacho.js?<?php echo date('Y.m.d.H.i.s') ?>"></script>
