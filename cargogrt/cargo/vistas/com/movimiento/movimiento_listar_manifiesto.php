<div>
    ...
    <div class="row">
        ...
        <input type="hidden" id="descripcion" value="<?php echo $_GET['descripcion']; ?>" />
                ...
                <div class="portlet-body">
                    <div style="display: flex;justify-content: space-between;">
                        <div class="input-group col-md-4">
                            ...
                            <div class="form-group col-md-6">
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <select name="cboAgenciaDestino" id="cboAgenciaDestino" class="select2" placeholder="Seleccione destino">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <select name="cboCopiloto" id="cboCopiloto" class="select2" placeholder="Seleccione conductor"></select>
                            </div>
                        </div>
                        
                          <div class="form-group col-md-2">
                            <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button type="button" href="#bg-info" style="width: 155px;" onclick="AbrirDespacho();" value="enviar" id="abrir" class="btn btn-info"><i class="fa fa-unlock"></i> Abrir Despacho
                        </button> 
                            </div>
                        </div>
                    ...
                    <div class="row" style="display: flex;align-items: center;">
                        <div class="form-group col-md-1" style="text-align: end;">
                            <label>Manifiestos</label>
                        </div>
                        <div class="form-group col-md-11">
                            <select name="cboManifiesto" id="cboManifiesto" class="select2" multiple="multiple" placeholder="Seleccione Manifiesto"></select>
                        </div>
                    </div>
...
<script src="vistas/com/movimiento/movimiento_listar_manifiesto.js"></script>