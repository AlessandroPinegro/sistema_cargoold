...
<div class="row">
    ...
    <div class="col-lg-12 form-group">
        <div class="row">
            ...
            <div class="col-md-2">
                <select name="cboComprobanteTipo" id="cboComprobanteTipo" class="select2"></select>
            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="cboCliente"><label id="lblClienteCbo">Cliente</label>
                                        <span class="divider"></span> <a onclick="cargarPersona('Cliente');"><i class="ion-person-add" tooltip-btndata-toggle="tooltip" title="Agregar cliente" style="color: #CB932A;"></i></a>
                                    ...
                                    <select name="cboCliente" id="cboCliente" class="select2" onclick="obtenerPersonaDireccion('Cliente', this.value);"></select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="cboDestinatario"><label id="lblDestinatarioCbo">Destinatario</label>
                                        <span class="divider"></span> <a onclick="cargarPersona('Destinatario');"><i class="ion-person-add" tooltip-btndata-toggle="tooltip" title="Agregar cliente" style="color: #CB932A;"></i></a>
                                    ...
                                    <select name="cboDestinatario" id="cboDestinatario" class="select2" onclick="obtenerPersonaDireccion('Destinatario', this.value);"></select>
                                </div>
                                <div class="form-group">
                                    <label for="cboAutorizado"><label>Autorizado</label>
                                        <span class="divider"></span> <a onclick="cargarPersona('Autorizado');"><i class="ion-person-add" tooltip-btndata-toggle="tooltip" title="Agregar cliente" style="color: #CB932A;"></i></a>
            ...
            <div class="row text-center">
                ...
                <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>
                    <div id="contenedorTotalDiv">
                        <h4 id="contenedorTotal"><input type="number" id="txtTotal" name="txtTotal" class="form-control" value=""  style="text-align: center;" /></h4>
                ...
                <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>
                    <div id="contenedorIgvDiv">
                        <h4 id="contenedorIgv"><input type="number" id="txtIgv" name="txtIgv" class="form-control" value=""  style="text-align: center;" /></h4>
                ...
                <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>
                    <div id="contenedorSubTotalDiv">
                        <h4 id="contenedorSubTotal"><input type="number" id="txtSubTotal" name="txtSubTotal" class="form-control" value=""  style="text-align: center;" /></h4>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div style="float: right;padding-top: 25px;" id="divAccionesEnvio">
                        ...
                        &nbsp;&nbsp;<button type="button" class="btn btn-info" onclick="enviar()" name="env" id="env"><i class="fa fa-send-o"></i> Generar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="divMedidaProducto" >
                    <div  class="row">
                        <div class="col-md-12 text-center">
                            <img id="myImg" src="vistas/images/medida_caja.jpg" onerror="this.src='vistas/images/medida_caja.jpg'"  />
                        </div>
                    </div>
                    <br/>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <label>&nbsp;</label>
                            <input type="number" id="txtPeso" name="txtPeso" class="form-control" required="" aria-required="true" value="1" maxlength="25" style="text-align: right;" onchange="obtenerPrecioCalculado()" onkeyup="obtenerPrecioCalculado()"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label>Cantidad *</label>
                        <input type="number" id="txtCantidad" name="txtCantidad" class="form-control" required="" aria-required="true" value="1" maxlength="25" style="text-align: right;" onchange="hallarSubTotalDetalle()" onkeyup="hallarSubTotalDetalle()"/>
                    </div>
                    <!--                            <div class="form-group col-md-6">
                                                    <label>Unidad de medida *</label>
                                                    <select name="cboUnidadMedida" id="cboUnidadMedida" class="select2" onchange="obtenerPrecioUnitario()"></select>
                ...
                <div class="row">
                    ...
                    <!--                            <div class="form-group col-md-6">
                                                    ...
                                                    <select name="cboPrecioTipo" id="cboPrecioTipo" class="select2" onchange=""></select>
                                                </div>-->
                </div>
                <div class="row">
                    <div class="form-group col-md-6"></div>
...
<script src="vistas/com/movimiento/movimiento_entrega.js?<?php echo date('Y.m.d.H.i.s') ?>"></script>
</body>
</html>