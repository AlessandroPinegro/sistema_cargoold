...
<html lang="es">    
    ...
    <body> 
                            ...
                            <div id="contenedorDetalle">    
                                <div class="col-md-12">                                
                                        ...
                                        <div class="form-group">                                      
                                            <div class="col-md-6" style="text-align: left;">                  
                                                <div id="contenedorChkIncluyeIGV" hidden="true">              
                                                    <label class="cr-styled" style="text-align: left;" >                         
                                                        <input type="checkbox" id="chkIncluyeIGV" onclick="onChangeCheckIncluyeIGV();" checked>    
                                                        <i class="fa"></i>                                                 
                                    ...
                                    <div class="row text-center m-t-10 m-b-10">
                                        ...
                                        <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>   
                                            <div id="contenedorOtrosCargosDiv" hidden="true">                                 
                                                <h4 id="contenedorOtrosCargos"></h4>                                
                                                <median class="text-uppercase">Otros cargos</median>                 
                                            </div>                                      
                                        </div>  
                                        <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>   
                                            <div id="contenedorDevCargosDiv" hidden="true">                                 
                                                <h4 id="contenedorDevCargos"></h4>                                
                                                <median class="text-uppercase">Devolución cargo</median>                 
                                            </div>                                      
                                        </div>  
                                        <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>   
                                            <div id="contenedorCostoRepartoDiv" hidden="true">                                 
                                                <h4 id="contenedorCostoReparto"></h4>                                
                                                <median class="text-uppercase">Costo de reparto</median>                 
                                            </div>                                      
                                        </div>  
                                        <div class="form-group col-lg-2 col-md-2 col-sm-4 col-xs-6" style='float: right;'>   
                                            <div id="contenedorAjustePrecioDiv" hidden="true">                                 
                                                <h4 id="contenedorAjustePrecio"></h4>                                
                                                <median class="text-uppercase">Ajuste de precio</median>                 
                                            </div>                                      
                                        </div> 
                                    </div>   
                                    <div class="row text-center m-t-10 m-b-10">           
        ...
        <script src="vistas/com/movimiento/movimiento_form_tablas.js">
        </script>    
    </body>
</html>