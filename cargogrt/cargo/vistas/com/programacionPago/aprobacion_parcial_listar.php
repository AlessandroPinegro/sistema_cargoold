    ...
    <div class="row">
        <div class="panel panel-default m-t-20 p-t-0" style="padding-left: 0px;padding-bottom: 1px;padding-right: 0px;">
            ...
            <ul class="nav nav-tabs nav-justified">
                ...
                <li class="">
                    <a href="#tabProgramacionPagoDetalle" data-toggle="tab" aria-expanded="false" onclick="actualizarTabActivo(2)">
                        <span class="visible-xs"><i class="ion-person-stalker"></i></span>
                        <span class="hidden-xs">Detalle de aprobaciones parciales</span>
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content" style="margin: 0px;padding: 15px"> 
                        ...
                        <div class="col-md-12" style="padding-top: 20px">
                            <table id="datatable" class="table table-small-font table-striped table-hover" >
                                <thead>                                      
                                    <tr>
                                        ...
                                        <th style='text-align:center;'>F.Ind</th>                                        
                            ...
                            <div style="clear:left">
                                <p id="divLeyenda">
                                    <br>
                                    <b>Leyenda:</b>&nbsp;&nbsp;
                                    <i class='fa fa-calendar-o' style='color:green;'></i> Registrar aprobación parcial &nbsp;&nbsp;&nbsp;
                ...
                <!--PESTAÑA DETALLE PROGRAMACION PAGO-->
                <div class="tab-pane" id="tabProgramacionPagoDetalle">
                    <div class="row">
                        <div class="input-group m-t-10">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="padding-left: 0px;">                                    
                                                ...
                                                <li>
                                                    ...
                                                    <div class="form-group col-md-10">
                                                        <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <select name="cboEstadoPPago" id="cboEstadoPPago" class="select2" style="width: 200px">
                                                                        <option value="0">Todos</option>
                                                                        <option value="1">Por aprobar</option>
                                                                        <option value="3">Aprobado</option>
                                                                        <option value="6">Liberado</option>
                                                                        <!--<option value="5">Pagado totalmente</option>-->
                                                                    </select>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                </div>
                    ...
                    <div style="padding-top: 20px">
                        <table id="datatableProgramacionPagoDetalle" class="table table-small-font table-striped table-hover"  style="width: 100%">
                            <thead>                                      
                                <tr>
                                    <th style='text-align:center;'>Acc.</th>
                                    <th style='text-align:center;'>Documento</th>
                        ...
                        <div style="clear:left">
                            <p id="divLeyendaPP">
                                <br>
                                <b>Leyenda:</b>&nbsp;&nbsp;
                                <i class='fa fa-calendar-o' style='color:green;'></i> Editar aprobación parcial &nbsp;&nbsp;&nbsp;
                                <i class='fa fa-lock' style='color:red;'></i> Por aprobar &nbsp;&nbsp;&nbsp;
                                <i class='fa fa-unlock' style='color:blue;'></i> Aprobado &nbsp;&nbsp;&nbsp;
                ...
                <!--FIN PESTAÑA DETALLE PROGRAMACION PAGO-->
            </div>                    
        </div>
    </div>
</div>
...
<script src="vistas/com/programacionPago/aprobacion_parcial_listar.js"></script>