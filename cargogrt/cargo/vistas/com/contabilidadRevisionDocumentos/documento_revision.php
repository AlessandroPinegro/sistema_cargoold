                    ...
                    <div style="clear:left">
                        <p id="divLeyenda">
                            <!--                            <b>Leyenda:</b>&nbsp;&nbsp;
                                                        ...
                                                        <i class="ion-ios7-keypad" style="color:#615ca8"></i> Asignar códigos únicos &nbsp;&nbsp;&nbsp;-->
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">                                  
                <div class="row">      
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div id="divBtnAprobarRechazar" class="input-group m-t-10" style="float: right">
...
<div id="modalRechazarDocumentoRevision"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
...
<script src="vistas/com/contabilidadRevisionDocumentos/documento_revision.js"></script>