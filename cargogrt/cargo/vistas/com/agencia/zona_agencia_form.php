...
<body>
        ...
        <div class="col-md-12 ">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-md-12 ">
                        <div class="panel-body">
                            <form id="frm_zona" method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <i id='msj_agencia' style='color:red;font-style: normal;' hidden></i>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <button type="button" onclick="guardarZona()" value="enviar" name="env" id="env" class="btn btn-info w-sm m-b-5" style="border-radius: 0px;"><i class="fa fa-send-o"></i>&ensp;Enviar</button>&nbsp;&nbsp;
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="vistas/com/agencia/zona_agencia_form.js"></script>
</body>
