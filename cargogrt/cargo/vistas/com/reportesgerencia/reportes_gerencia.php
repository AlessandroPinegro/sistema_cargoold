...
<!--                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="true"  style="width: 100%; padding-top: 10px;padding-bottom: 10px;"><i class=" fa fa-plus-square-o"></i> Nueva <span class="caret"></span></button>
        ...
        <div class="form-group col-md-4">
                <label> &nbsp; </label>
                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <button type="button" href="#bg-info" onclick="BuscarResultadoReportenuevo1();" value="enviar" class="btn btn-info"><i class="ion-search"></i>&nbsp; Buscar</button>&nbsp;
                <a type="button" class="btn btn-success" onclick="ExportarReporteVentasSolesTotalExcel()" title="exportar excel"><i class="ion-archive"></i>&nbsp;Descargar</a>
                </div>
        </div>
                    ...
                    <thead >
                        <tr>
                           ...
                           <!-- <th style='text-align:center;' width="5%">F.Pedido</th>
                            ...
                            <th style='text-align:center;' >SerieCorrelativo</th>
                            <th style='text-align:center;' >Tipo_doc.</th>
                            <th style='text-align:center;' >Remitente</th>
                            <th style='text-align:center;' >Destinatario</th>
                            <th style='text-align:center;' >Modalidad</th>
                            <th style='text-align:center;' >Est. pedido</th>
                            <th style='text-align:center;' >Est. Cpe</th>
                            ...
                            <th style='text-align:center;' >Costo reparto</th>
                            <th style='text-align:center;' >Costo Recojo</th>
                            <th style='text-align:center;' >Ajuste de Precio</th>
                            <th style='text-align:center;' >Sub Total</th>
                            <th style='text-align:center;' >IGV</th>
                            <th style='text-align:center;' >Total</th>
                            <th style='text-align:center;' >Serie N/C</th>
                            <th style='text-align:center;' >Número N/C</th>
                            <th style='text-align:center;' >P.efectivo</th>
                            <th style='text-align:center;' >P.deposito</th>
...
<script src="vistas/com/reportesgerencia/reportes_gerencia.js"></script>
