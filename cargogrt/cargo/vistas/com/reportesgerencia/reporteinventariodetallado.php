...
<!--                            <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-expanded="true"  style="width: 100%; padding-top: 10px;padding-bottom: 10px;"><i class=" fa fa-plus-square-o"></i> Nueva <span class="caret"></span></button>
        ...
        <div class="form-group col-md-4">
                <label> &nbsp; </label>
                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <button type="button" href="#bg-info" onclick="BuscarResultadoInventarioDetalle();" value="enviar" class="btn btn-info"><i class="ion-search"></i>&nbsp; Buscar</button>&nbsp;
                <a type="button" class="btn btn-success" onclick="ExportarResultadoInventarioDetalleExcel()" title="exportar excel"><i class="ion-archive"></i>&nbsp;Descargar</a>
                </div>
        </div>
        ...
        <table id="datatable" class="table table-striped table-bordered" >
                <!-- class="table table-small-font table-striped table-hover" width="100%"> -->
                    ...
                    <tr>
                            ...
                            <th style='text-align:center;' >Indice Artículo</th>
                            <th style='text-align:center;' >Artículo desc.</th>
                            <th style='text-align:center;' >Tracking paquete</th>
                            <th style='text-align:center;' >F.Tracking</th>
                            <th style='text-align:center;' >Usuario Tracking</th>
...
<script src="vistas/com/reportesgerencia/reporteinventariodetallado.js"></script>
