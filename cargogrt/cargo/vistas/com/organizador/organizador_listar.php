    ...
    <body >
        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                <a href="#" style="border-radius: 0px;" class="btn btn-info w-md" onclick="nuevoOrganizador()"><i class=" fa fa-plus-square-o" style="font-size: 18px;"></i>&nbsp;&nbsp;<i> </i><i> </i>Nuevo</a>
                <br><br>
                ...
                <div style="clear:left">
                    <p><b>Leyenda:</b>&nbsp;&nbsp;
                        ...
                        <i class='fa fa-qrcode' aria-hidden='true' style='color:#1ca8dd;'></i> Ver código QR &nbsp;&nbsp;&nbsp;
                    </p>
                </div>
            </div>
        </div>
