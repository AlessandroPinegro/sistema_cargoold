                            ...
                            <div id="bg-info" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" onclick="exportarRegistroCompras('excel');" value="Exportar" name="env" id="env" class="btn btn-info w-md" style="border-radius: 0px;">&ensp;Exportar excel</button>&nbsp;&nbsp;  
                                        <button type="button" onclick="exportarRegistroCompras('txt');" value="Exportar" name="env" id="env" class="btn btn-success w-md" style="border-radius: 0px;">&ensp;Exportar txt</button>&nbsp;&nbsp;  
