...
function imprimirBienUnicoNuevo() {
    cargarDatosBusqueda();
    ...
    $.post(URL_BASE + 'script/almacen/qrBienUnicoImprimirXCriteriosNuevo.php', {criteriosBusqueda: valoresBusquedaBienUnico}, function (result) {
        WinId.document.open();
        WinId.document.write(result);
        WinId.document.close();
        WinId.focus();
