...
class ImportacionExcel2
{
    ...
    public static function importExcelTarifario($fileExcel, $usuarioCreacion)
    {
        ...
        for ($indiceFila = 2; $indiceFila <= $numeroFilas; $indiceFila++) {
            ...
            $persona = $hojaActual->getCellByColumnAndRow('5', $indiceFila)->getValue();
            ...
            $articulo = $hojaActual->getCellByColumnAndRow('8', $indiceFila)->getValue();
            ...
            // if ($moneda != 2 && $moneda != 4) {
            //     throw new WarningException("Moneda en el formato debe ser 2:soles , 4:dolares");
            // }
            ...
            $resultado[] = array(
                $result[0]["error"], $result[0]["errorAgenciO"], $result[0]["errorAgenciaD"], $result[0]["errorPersona"],
                $result[0]["agenciaO"], $result[0]["agenciaD"], $result[0]["codPersona"], $result[0]["persona"], $result[0]["codArticulo"], $result[0]["articulo"],
                $result[0]["moneda"], $result[0]["precioKg"], $result[0]["precioSobre"], $result[0]["precio5kg"], $result[0]["precio5kg"], $result[0]["precio5kg"],
                $result[0]["errorArticulo"], $result[0]["errorPrecio5Kg"], $result[0]["errorinsert"]
            );
        }
    ...
    public static function importExcelBien($fileExcel, $usuarioCreacion)
    {
        ...
        for ($indiceFila = 2; $indiceFila <= $numeroFilas; $indiceFila++) {
            ...
            $result = BienNegocio::create()->importBien(
                $codigoBien,
                $descripcion,
                $tipoBienCodigo,
                $largo,
            ...
            $resultado[] = array(
                $result[0]["error"], $result[0]["codigoBien"], $result[0]["descripcionBien"], $result[0]["bienTipo"],
    ...
    public static function importExcelTarifarioZona($fileExcel, $usuarioCreacion)
    {
        ...
        for ($indiceFila = 4; $indiceFila <= $numeroFilas; $indiceFila++) {
            ...
            $resultado[] = array(
                $result[0]["error"], $result[0]["errorAgencia"], $result[0]["errorZona"],
