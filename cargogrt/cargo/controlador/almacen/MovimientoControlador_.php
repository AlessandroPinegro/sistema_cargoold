...
//        $importeTotalInafectas = $this->getParametro("importeTotalInafectas");
        ...
        return MovimientoNegocio::create()->validarGenerarDocumentoAdicional($opcionId, $usuarioId, $documentoTipoId,
                $camposDinamicos, $detalle, $documentoARelacionar, $valorCheck, $comentario,$checkIgv,$monedaId,
                $accionEnvio,$tipoPago,$listaPagoProgramacion, $anticiposAAplicar,$periodoId, $percepcion, $origen_destino);
...
//        
    ...
    public function enviarCorreosMovimiento() {   
        ...
        return MovimientoNegocio::create()->enviarCorreosMovimiento($usuarioId,$txtCorreo,$correosSeleccionados,
                $respuestaCorreo,$comentario);
    ...
    public function enviarCorreoXAccion() {
        ...
        return MovimientoNegocio::create()->enviarCorreoXAccion($correo,$comentario,$accion,$documentoId,
...
//                                ));
        ...
        $resDataDocumento= MovimientoNegocio::create()->guardarXAccionEnvio($opcionId, $usuarioId, $documentoTipoId,
                $camposDinamicos, $detalle, $documentoARelacionar, $valorCheck, $comentario,$checkIgv,$monedaId,
                $accionEnvio,$tipoPago,$listaPagoProgramacion, $bandAtencion=true);
    ...
    public function guardarDocumentoPago() {       
        ...
        $resDataDocumento= MovimientoNegocio::create()->guardarXAccionEnvio($opcionId, $usuarioId, $documentoTipoId,
                $camposDinamicos, $detalle, $documentoARelacionar, $valorCheck, $comentario,$checkIgv,$monedaId,
                $accionEnvio,$tipoPago,$listaPagoProgramacion,null,$periodoId);
        ...
        if ($dataEmpresa[0]['efactura'] == 1) {            
            ...
            MovimientoNegocio::create()->generarDocumentoElectronico($documentoId, $documentoTipo[0]['identificador_negocio']);
        }
        //----------------------        
    ...
    public function enviarEdicion() {
        ...
        return MovimientoNegocio::create()->guardarXAccionEnvioEdicion($documentoId,$opcionId, $usuarioId, $documentoTipoId,
                $camposDinamicos, $detalle,$listaDetalleEliminar, $documentoARelacionar, $valorCheck, $comentario,$checkIgv,$monedaId,
                $accionEnvio,$tipoPago,$listaPagoProgramacion, $anticiposAAplicar,$periodoId, $percepcion);
    }
