...
// 		$html = '<table>
// 		<tr>
// 				<td>I.E.P COLEGIO DE CIENCIAS</td>
// 				<td>FICHA INTERNA DE MATRCULA 2022</td>
// 		</tr>
// </table>';
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	// public function Header() {
	// 	$html = '<table><tr><td>TABLAAA</td></tr></table>';
  //   return $this->writeHTMLCell($w = 0, $h = 0, $x = '', $y = '', $html, $border = 0, $ln = 1, $fill = 0, $reseth = true, $align = 'top', $autopadding = true);  		
	// }
	/**
